...
class Overlay @JvmOverloads constructor(
    ...
    private fun drawFaceLandmark(face: Face, canvas: Canvas)
    {
        ...
        drawFaceLandmark(leftEar,canvas)
        drawFaceLandmark(rightEar,canvas)
        drawFaceLandmark(leftMouth,canvas)
        drawFaceLandmark(rightMouth,canvas)
        drawFaceLandmark(bottomMouth,canvas)
